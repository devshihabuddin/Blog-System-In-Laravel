<aside id="leftsidebar" class="sidebar">
        ...
        <div class="info-container">
            ...
            <div class="btn-group user-helper-dropdown">
                ...
                <ul class="dropdown-menu pull-right">
                    <li>
                        <a href="{{ Auth::user()->role->id == 1 ? route('admin.settings.index') : route('author.settings.index') }}"><i class="material-icons">settings</i>Settings</a>
                    </li>
    ...
    <div class="legal">
        <div class="copyright">
            &copy; 2021 - 2022 <a href="javascript:void(0);">Shihab Uddin</a>.
        </div>
    </div>
    <!-- #Footer -->
</aside>
