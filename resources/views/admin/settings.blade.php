                ...
                <div class="body">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation">
                            <a href="#change_passwordzz_with_icon_title" data-toggle="tab">
                    ...
                    <div class="tab-content">
                            ...
                            <form class="form-horizontal" action="{{route('admin.profile.update')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="email" class="form-control" placeholder="Enter your email address" value="{{ Auth::user()->email }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea name="about" class="form-control" cols="30" rows="5">{{ Auth::user()->about }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="change_passwordzz_with_icon_title">
