                                    ...
                                    @foreach ($post->comments as $comment)
                                        <tr>
                                            <td>
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <h4 class="media-hedding">{{ $comment->user->name }}
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a href="{{route('post.details',$comment->post->slug) }}">
                                                            <h4 class="media-hedding">{{ Str::limit($comment->post->title,'30') }}</h4>
                                                        </a>
                                            ...
                                            <td>
                                                ...
                                                <form id="form-comment-{{$comment->id}}" action="{{route('author.comment.destroy',$comment->id)}}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
